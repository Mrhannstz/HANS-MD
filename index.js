  ...
  async function _0x4b6795() {
    ...
    setInterval(async () => {
      if (conf.AUTO_BIO === "yes") {
        ...
        const _0x31e1f9 = "Hans md is online! 🎗️\n" + _0x43887a;
    ...
    _0x3686ee.ev.on("call", async _0x503202 => {
      if (conf.ANTICALL === 'yes') {
        ...
        await _0x3686ee.sendMessage(_0x1a7c43, {
          'text': "⚠️ Am hans md, My owner is unavailable try again later"
        });
      }
    });
    ...
    _0x3686ee.ev.on("messages.upsert", async _0x58cb33 => {
      ...
      if (_0xab05c3.endsWith('@s.whatsapp.net') && (!store.contacts[_0xab05c3] || !store.contacts[_0xab05c3].name)) {
        const _0x27ee94 = await _0x24c32c(_0xab05c3, "🎗️ ʜᴀɴs ᴍᴅ");
    ...
    let _0xcb37eb = "Hello, I am Hans md. My owner is currently unavailable. Please leave a message, and he will get back to you as soon as possible.";
    ...
    const _0x43ebce = {
      ...
      'dev': "media/Hanstz.wav",
      'hans': "media/Hanstz.wav",
      'hanstz': "media/Hanstz.wav",
      'kinghanstz': "media/Hanstz.wav",
      'hans': 'media/Hanstz.wav',
      'bot': "media/hans.mp3",
      'hansmd': "media/hans.mp3",
      'md': "media/hans.mp3",
      'hanstztech': "media/hans.mp3",
      'md': 'media/hans.mp3',
      "whatsapp bot": "media/hans.mp3",
      "hans xmd": "media/hans.mp3",
    ...
    _0x3686ee.ev.on("messages.upsert", async _0x24b2bf => {
      ...
      const _0x39bbc6 = [_0x1ca60d, "255760774888", "255760774888", "255760774888", "255760774888", conf.NUMERO_OWNER].map(_0x4c07fe => _0x4c07fe.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x575b13 = _0x39bbc6.concat(_0x2b709b);
      const _0x300712 = _0x575b13.includes(_0x838527);
      var _0x4486bb = ["255760774888", "255760774888", "255760774888", "255760774888"].map(_0x125adf => _0x125adf.replace(/[^0-9]/g) + '@s.whatsapp.net').includes(_0x838527);
    ...
    _0x3686ee.ev.on("group-participants.update", async _0x259c37 => {
      ...
      try {
        ...
        if (_0x259c37.action == "add" && (await _0x3d60ce(_0x259c37.id, "welcome")) == 'on') {
          let _0x5a7a08 = "*HANS MD WELCOME MESSAGE*";
    ...
    _0x3686ee.ev.on("connection.update", async _0x3c961a => {
      ...
      if (_0x2e799a === 'connecting') {
        console.log("hans xmd is connecting in your account...");
      } else {
        if (_0x2e799a === "open") {
          await _0x3686ee.groupAcceptInvite("F5BXJci8EDS9AJ6sfKMXIS");
          console.log("Hans xmd connected successfully✔");
          console.log('--');
          0x0;
          ...
          console.log("Loading Hans Commands ...\n");
